...
public class SchemaMaxLength {
  public int maxLength;
  public EndPointParameter epp;

  public SchemaMaxLength(int maxLength, EndPointParameter epp) {
    this.maxLength = maxLength;
    this.epp = epp;
  }


  public static SchemaMaxLength toMaxLength(ConditionPred pred) {
    ...
    if(pred.uniCond instanceof LeExpr){
      ...
      if(op1 instanceof VirtualInvokeExpr && op2 instanceof IntConstant){
        ...
        if(lhs.getBase() instanceof EndPointParameter){
          ...
          if(ref.getDeclaringClass().getName().equals("java.lang.String") && ref.getName().equals("length")){
            return new SchemaMaxLength(rhs.value, epp);
          }
        }
      }
    }
      ...
      if(op1 instanceof VirtualInvokeExpr && op2 instanceof IntConstant){
        ...
        if(lhs.getBase() instanceof EndPointParameter){
          ...
          SootMethodRef ref= lhs.getMethodRef();
          if(ref.getDeclaringClass().getName().equals("java.lang.String") && ref.getName().equals("length")){
            return new SchemaMaxLength(rhs.value-1, epp);
          }
        }
      }
    }
    ...
    // if(evalTo==true){
    //   if(pred.pred instanceof LeExpr){
    ...
    //         if(ref.getDeclaringClass().getName().equals("java.lang.String") && ref.getName().equals("length")){
    //           return new SchemaMaxLength(op2.value, epp);
    //         }
    //       }
    //     }
    //   }
    //   else if(pred.pred instanceof LtExpr){
    ...
    //         SootMethodRef ref= op1.getMethodRef();
    //         if(ref.getDeclaringClass().getName().equals("java.lang.String") && ref.getName().equals("length")){
    //           return new SchemaMaxLength(op2.value-1, epp);
    //         }
    //       }
    //     }
    //   }
